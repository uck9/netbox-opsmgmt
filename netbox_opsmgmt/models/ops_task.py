...
from netbox_opsmgmt.constants.ops_task import OPS_TASK_ASSIGNMENT_MODELS
from netbox_opsmgmt.choices.ops_task import OpsTaskTypeChoices, OpsTaskOutcomeChoices
...
class OpsTask(PrimaryModel):
    ...
    task_type = models.CharField(max_length=50, choices=OpsTaskTypeChoices, default=OpsTaskTypeChoices.CURRENCY_UPGRADE)
    ...
    task_outcome = models.CharField(max_length=50, choices=OpsTaskOutcomeChoices, default=OpsTaskOutcomeChoices.NO_ISSUES)
    outcome_details = models.TextField(blank=True, default="", verbose_name="Outcome Details")
    task_completed = models.BooleanField(default=False)

    assigned_object_type = models.ForeignKey(
        to=ContentType,
        limit_choices_to=OPS_TASK_ASSIGNMENT_MODELS,
