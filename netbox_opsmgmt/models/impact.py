...
from netbox_opsmgmt.constants.impact import IMPACT_ASSIGNMENT_MODELS
from netbox_opsmgmt.choices.impact import ImpactRatingChoices
...
class Impact(PrimaryModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:netbox_opsmgmt:impact', args=[self.pk])
