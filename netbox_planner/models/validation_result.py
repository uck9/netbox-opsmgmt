...
from netbox_planner.constants.validation_result import VALIDATION_RESULT_ASSIGNMENT_MODELS
from netbox_planner.choices.validation_result import ValidationTypeChoices
