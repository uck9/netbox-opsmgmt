...
# from netbox_planner.forms.model_forms import TaskForm
from netbox_planner.models import OpsTask
from netbox_planner.tables import OpsTaskTable
...
class OpsTaskEditView(ObjectEditView):
    template_name = 'netbox_planner/OpsTask_edit.html'
    queryset = OpsTask.objects.all()
    form = OpsTaskForm
